...
namespace WebApi.Controllers
{
    ...
    public class DynamicFormConfigurationController(IServiceManager business) : Controller
    {
        ...
        public async Task<IActionResult> GetDynamicFormConfiguration(string? search, bool delflag, string? formTypeAdv,string? fieldNameAdv,string? fieldTypeAdv,string? fieldLengthAdv,string? mandatoryAdv,string? fieldElementAdv,string? optionDataResourceAdv,string? dbResourceAdv,string? queryAdv,string? dataOptionAdv,string? sequenceAdv)
        {
            var result = await business.DynamicFormConfiguration.GetDynamicFormConfiguration(search, delflag,formTypeAdv,fieldNameAdv,fieldTypeAdv,fieldLengthAdv,mandatoryAdv,fieldElementAdv,optionDataResourceAdv,dbResourceAdv,queryAdv,dataOptionAdv,sequenceAdv);
            return Ok(result);
