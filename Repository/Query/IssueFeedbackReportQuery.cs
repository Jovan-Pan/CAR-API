...
namespace Repository.Query
{
    public class IssueFeedbackReportQuery
    {
        ...
        select  
        Plant,FormType,FormNo,DetectionDate,StatusOfFinding,Product,Model,MaterialType,MaterialCode,MaterialDescription,NcQty,SamplingCheck,NcRatio,Dept,VendorCode
