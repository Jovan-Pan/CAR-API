...
namespace Services.Helper
{
    public class MailBodyContentDetail
    {
        ...
        <table style=""border-collapse: collapse; width: 100%; border: 1px solid black;"">
            <tr>
                <td style=""border: 1px solid black; padding: 8px;""><b>Plant</b></td>
                <td style=""border: 1px solid black; padding: 8px;""><b>@Plant</b></td>
            ...
            <tr>
                <td style=""border: 1px solid black; padding: 8px;""><b>Dept</b></td>
                <td style=""border: 1px solid black; padding: 8px;""><b>@Dept</b></td>
            ...
            <tr>
                ...
                <td style=""border: 1px solid black; padding: 8px;""><b>Comment</b></td>
                <td style=""border: 1px solid black; padding: 8px;""><b>@Comment</b></td>
            </tr>
        </table>
        ";
